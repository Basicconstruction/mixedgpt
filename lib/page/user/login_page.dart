...
class LoginPageState extends State<LoginPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [_forgetPasswordButton(), _registerButton()],
              )
            ],
          ),
        ));
  ...
  _login() async {
    ...
    var response =
        await HttpService.post('$supplier/${ApiUrl.login}', param: formData);
    if (response != null) {
      ...
      RouterUtil.pop(context); //不兼容因素
    } else {
      MessageWidget.show(MString.loginFail);
      var data = {'username': '', 'isLogin': false};
      Call.dispatch(Notify.loginStatus, data: data);
    }
  }
}
